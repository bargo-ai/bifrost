...
| `stream_replay_duration_ms` | No | Total time to replay an allowed stream buffered by block-capable output guardrails. Defaults to `200`; `0` sends all buffered events immediately. |
