...
// ResolveUseAnthropicEndpboints reports whether the request should be routed through Anthropic-compatible endpoints
func ResolveUseAnthropicEndpboints(ctx *schemas.BifrostContext, key schemas.Key) bool {
