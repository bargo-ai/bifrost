...
function SGLSection({ config, onChange, disabled }: ProviderSectionProps) {
	return (
		<div className="space-y-4">
			<SectionHeader title="SGLang overrides" description="Override key-level SGLang defaults for this deployment." />
			<div className="flex items-start justify-between gap-4 rounded-md border p-3">
				<div className="space-y-0.5">
					<label className="text-sm font-medium">Use Anthropic endpoints</label>
					<p className="text-muted-foreground text-xs">
						Route text, chat, and responses requests through SGLang&apos;s Anthropic-compatible endpoints instead of its
